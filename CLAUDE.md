...
- **Phase**: 0 완료 — Phase 1 진입 가능
- **스캐폴딩**: Slice 01~08 완료 (workspace, turbo, config-\*, eslint/prettier, testing, CI, docker, governance)
- **다음**: Phase 1 디자인 시스템 (`packages/ui` + Storybook) — `/planning design-system`
- **참고 문서**:
